...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DXFix — أداة إصلاح ملفات DXF لورش CNC" },
      { name: "description", content: "أصلح، افحص، وقيّم ملفات DXF فوراً قبل القص. مجاني خلال فترة الإطلاق." },
      { property: "og:title", content: "DXFix — DXF Repair for CNC Workshops" },
